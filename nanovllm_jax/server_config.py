...
_ENGINE_ENV_MAP: dict[str, tuple[str, type]] = {
    ...
    "startup_warmup_prefill_token_buckets": ("NANO_VLLM_JAX_STARTUP_WARMUP_PREFILL_TOKEN_BUCKETS", str),
    "startup_warmup_batch_size_buckets": ("NANO_VLLM_JAX_STARTUP_WARMUP_BATCH_SIZE_BUCKETS", str),
    "startup_warmup_decode_block_table_buckets": ("NANO_VLLM_JAX_STARTUP_WARMUP_DECODE_BLOCK_TABLE_BUCKETS", str),
    "startup_warmup_include_sampled_routes": ("NANO_VLLM_JAX_STARTUP_WARMUP_INCLUDE_SAMPLED_ROUTES", bool),
    ...
    "max_blocks_per_seq": ("NANO_VLLM_JAX_MAX_BLOCKS_PER_SEQ", int),
    "prefix_cache": ("NANO_VLLM_JAX_PREFIX_CACHE", bool),
    "speculative_method": ("NANO_VLLM_JAX_SPECULATIVE_METHOD", str),
    "draft_sample_method": ("NANO_VLLM_JAX_DRAFT_SAMPLE_METHOD", str),
    "mtp_verifier_impl": ("NANO_VLLM_JAX_MTP_VERIFIER_IMPL", str),
    "mtp_batch_accept_policy": ("NANO_VLLM_JAX_MTP_BATCH_ACCEPT_POLICY", str),
    ...
    "mtp_chain_hidden_source": ("NANO_VLLM_JAX_MTP_CHAIN_HIDDEN_SOURCE", str),
    "mtp_chain_mode": ("NANO_VLLM_JAX_MTP_CHAIN_MODE", str),
    ...
    "lm_head_topk_impl": ("NANO_VLLM_JAX_LM_HEAD_TOPK_IMPL", str),
    "lm_head_greedy_top1_impl": ("NANO_VLLM_JAX_LM_HEAD_GREEDY_TOP1_IMPL", str),
    ...
    "full_attention_prefill_impl": ("NANO_VLLM_JAX_FULL_ATTN_PREFILL_IMPL", str),
...
def _runtime_fastpaths_to_engine(runtime_section: dict) -> dict[str, Any]:
    ...
    mapping = {
        ...
        "sampled_token": "sampled_token_fastpath",
        ...
        "lm_head_topk_impl": "lm_head_topk_impl",
        "lm_head_greedy_top1_impl": "lm_head_greedy_top1_impl",
...
def _runtime_section_to_env(runtime_section: dict) -> dict[str, str]:
    ...
    fastpath_map = {
        ...
        "sampled_token": "NANO_VLLM_JAX_SAMPLED_TOKEN_FASTPATH",
